...
<form name="f1" action="dincosts.jsp" onsubmit="return check()" method=post>
<body background="images/center.jpg" alink=blue vlink=blue>
<b>Display the Dealers order information who placed order on
<br><br>
<table>
...
<hr color=lightblue>
<jsp:include page="dlcustinfo.jsp" flush="true"/>
</html>
