...
<form name="f1" action="indsfrm.jsp" onsubmit="return check()" method=post>
<a href="adlink.html">back</a><br><br>
<b>Display the Customer Info whoose Orders need to be dispatched beween 
<br><br>
<table>
<tr><td>
...
<hr color="lightblue">
<jsp:include page="ddispatch.jsp" flush="true"/>
</html>
