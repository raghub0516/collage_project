...
<form name="f1" action="inmail.jsp" onsubmit="return check()" method=post>
<b>Display the mails recieved from
<br><br>
<table>
<tr><td>
<select size=1 name="fmon" style="font-size:9pt;font-family:Century Gothic;color:;background-color:lightblue;">
...
<select size=1 name="fdy" style="font-size:9pt;font-family:Century Gothic;color:;background-color:lightblue;">
...
<td>
<select size=1 name="fyr" style="font-size:9pt;font-family:Century Gothic;color:;background-color:lightblue;">
...
<b>&nbsp; to &nbsp;</b></td>
<td>
<select size=1 name="smon" style="font-size:9pt;font-family:Century Gothic;color:;background-color:lightblue;">
...
<option value="november">November
<option value="december">December</select></td><td>
<select size=1 name="sdy" style="font-size:9pt;font-family:Century Gothic;color:;background-color:lightblue;">
...
<td>
<select size=1 name="syr" style="font-size:9pt;font-family:Century Gothic;color:;background-color:lightblue;">
...
<hr color="yellow">
<jsp:include page="mails.jsp" flush="true"/>
</html>
