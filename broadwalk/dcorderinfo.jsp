...
<a href="dincosts.jsp">back</a><br><br>
...
out.println("<td><table border=\"1\"bordercolor=b75b00  cellpadding=4>");
out.println("<tr><td><b>OrderNo</b></td><td><b>ProductInfo</b></td></tr>"); 
String q3="select dordid from dpays where dcustid='"+id+"' and ";
...
String q7="select prodid,quantity,didamt from diorder where dcid='"+id+"'";
String q8=" and dordid='"+hd[j]+"'";
String q9=q7+q8;
out.println("<td><table border=\"1\"bordercolor=b75b00  cellpadding=4><tr>");
...
String d2=",to_char(dor+12,'dd-fmmonth-yyyy') from dpays where to_char(dor,'dd-fmmonth-yyyy')";
String d3="LIKE '"+date+"'";
String d=d1+d2+d3;
