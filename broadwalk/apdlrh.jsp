...
TARGET="_top" name="f1" onsubmit="return check()">
...
<tr><td></td><td><b>State Name </b></td><td>
<select name="sta" id="sta" style="font-size:9pt;font-family:Century Gothic;color:DCDCDC;background-color:lightblue;">
...
<tr><td></td><td><b>District Name  </b></td><td>
<select name="dst" id="district"style="font-size:9pt;font-family:Century Gothic;color:DCDCDC;background-color:lightblue;">
