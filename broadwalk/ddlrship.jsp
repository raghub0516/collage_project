...
{
alert("please enter State name in 15 chars only");
f1.sta.value="";
f1.sta.focus();
return false;
}
...
{
alert("please enter District name in 15 chars only");
f1.dst.value="";
f1.dst.focus();
return false;
}
...
<br><br>
<form action="ddlship.jsp" name="f1" onsubmit="return check()" method=post>
<b>Please Enter Following Information to remove DealerShip.</b>
<br><br>
<table>
<tr><td width=15%></td>
<td><b>Country Name  </b></td><td>
<input type="text" name="coun"value=India size=13 STYLE="background:lightblie"></td></tr>
<tr><td></td><td><b>State Name  </b></td><td><select name="sta" id="sta" style="font-size:9pt;font-family:Century Gothic;color:;background-color:lightblue;">
...
<b>Click <input type="submit" name="submit" value="O.K"> to Remove Dealer.</b>
</form>
</body>
</html> 