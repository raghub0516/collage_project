...
<center>
<font size=4 >
<u>Denayed Certificates Information</u>
</font>
  ...
  <%   try
   {
	  ...
	  String sqlSTMT="select bcid,pflag from passportcertificate where pk='"+(String)session.getAttribute("username")+"' and pflag='2'";
